...
export const gameLayoutSections: SectionConfig[] = [
  ...
  { key: 'Ad', visible: true, props: { slotId: 'GAME-AD-1', size: 'rectangle' } },
  { key: 'PopularGames', visible: true },
  { key: 'Ad', visible: true, props: { slotId: 'GAME-AD-2', size: 'banner' } },
  { key: 'HowToPlay', visible: true },
  { key: 'FAQ', visible: true },
  { key: 'Ad', visible: true, props: { slotId: 'GAME-AD-3', size: 'leaderboard' } },
]
